...
q111 = getproba(map,index1);
q112 = getproba(map,[index1(1) index1(2) index1(3)+1 ]);
q121 = getproba(map,[index1(1) index1(2)+1 index1(3) ]);
q122 = getproba(map,[index1(1) index1(2)+1 index1(3)+1 ]);
q211 = getproba(map,[index1(1)+1 index1(2) index1(3) ]);
q212 = getproba(map,[index1(1)+1 index1(2) index1(3)+1 ]);
q221 = getproba(map,[index1(1)+1 index1(2)+1 index1(3) ]);
q222 = getproba(map,[index1(1)+1 index1(2)+1 index1(3)+1 ]);
